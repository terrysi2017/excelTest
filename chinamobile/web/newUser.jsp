  ...
  <TR vAlign=top>
    <TD height="600" bgColor=#f1f3f9>
     ...
     <form method="POST" action="../addUser.do">
      <p>手机号码：<input type="text" name="mobile" size="20"></p>
      <p>漫游状态：<input type="radio" name="roamingStatus" value="P" checked>省内漫游 <input type="radio" name="roamingStatus" value="D">国内漫游 
      <input type="radio" name="roamingStatus" value="I">国际漫游</p>
      <p>通话级别：<input type="radio" value="L" checked name="comLevel">本地通话 
      <input type="radio" name="comLevel" value="D">国内长途 <input type="radio" name="comLevel" value="I">国际长途</p>
      <p>客户ID：<input type="text" name="userId" size="20" value="<%=customer.getCustomerId()%>" readonly></p>
