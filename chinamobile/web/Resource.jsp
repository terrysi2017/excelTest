...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <p>号码类型：<input type="Radio" name="nbtype" value="SIM" checked/>SIM &nbsp;&nbsp;<input type="Radio" name="nbtype" value="UIM">UIM</p>
    <p>指定号段：从<input type="text" name="startMobile" size="20" value="">到<input type="text" name="endMobile" size="20" value=""><input type="submit" value="提交" name="B1"><input type="reset" value="全部重写" name="B2"></p>
    </form>
    <hr>
