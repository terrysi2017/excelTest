...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="../addOperator.do">
      <p>登录ID：<input type="text" name="operatorId" size="20" value=""></p>
      <p>姓 名：<input type="text" name="operatorName" size="20" value=""></p>
      <p>密码：<input type="password" name="operatorPwd" size="20" value=""></p>
      <p>密码确认：<input type="password" name="operatorPwd1" size="20" value=""></p>
      <p>是否管理员：<input type="radio" value="1" name="isAdmin">是&nbsp;&nbsp;&nbsp; 
      <input type="radio" checked  name="isAdmin" value="0">否</p>
