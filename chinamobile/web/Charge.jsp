...
<h2>收费细项</h2>
    <form method="POST" action="../editCharge.do">
      ...
      <p>收费金额：<input type="text" name="charge" size="20" value="10"></p>
      <p><input type="submit" value="提交" name="B1"><input type="reset" value="全部重写" name="B2"></p>
    </form>
    <hr>
    <h2>业务收费</h2>
    <form method="POST" action="../editChargeRule.do">
      <p>业务：<select size="1" name="rule">
        <option value="O">开户业务</option>
      </select></p>
      <p>收费项目：<input type="checkbox" name="item" value="A" checked>开户费 
      <input type="checkbox" name="item" value="B">漫游费 <input type="checkbox" name="item" value="C">押金 
      <input type="checkbox" name="item" value="D" checked>入网费 <input type="checkbox" name="item" value="E" checked>选号费</p>
      <p><input type="submit" value="提交" name="B1"><input type="reset" value="全部重写" name="B2"></p>
    </form>   
